...
/**
 * Comparator for sort by x coordinate of first cube point.
 */
public class XFirstPointCubeObservableComparator implements Comparator<CubeObservable> {
    @Override
    public int compare(CubeObservable firstCubeObservable, CubeObservable secondCubeObservable) {
        ...
        double firstXCoordinate = firstCubePoint.getXCoordinate();
        double secondXCoordinate = secondCubePoint.getXCoordinate();
